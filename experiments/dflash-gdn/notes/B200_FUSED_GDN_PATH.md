...
- All traces contain `gdn_decode_post_conv_mtp_kernel<__nv_bfloat16, ratio, false>` during generation. Kernel names, counts, and trace paths are in the local artifact `results/b200-block8-20260922/kernel-probes/summary.json`; evidence files are excluded from Git.
